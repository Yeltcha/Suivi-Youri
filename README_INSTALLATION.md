...
La version 1.15.0 permet de définir une cible exacte ou une fourchette de répétitions lors de l’ajout et de la modification des exercices d’un programme. Elle corrige aussi l’étirement de la carte voisine lorsqu’une séance est dépliée dans la grille desktop. Elle conserve les intentions de séries lourdes, back-off et libres, la validation neutre, les comparaisons statistiques séparées par rôle et toutes les données déjà enregistrées.
